...
1. Pick your source: [Import Workflow Guide](import-workflow-guide.md)
   ...
   - Coming from Bear? See "Bear Notes Migration"
   - Coming from generic markdown? See "Generic Markdown Folder"
2. Then: [Getting Started for Power Users](getting-started-power-users.md) - Try your first query
3. Reference: [SQL Quick Reference](sql-quick-reference.md) - Query your migrated notes

**Result**: Your notes are imported and queryable ✅

### I want to automate my workflows

**Time**: 1-2 hours | **Goal**: Set up automated reporting and backups

1. Start: [Getting Started for Power Users](getting-started-power-users.md) - Understand basics
2. Learn SQL: [SQL Quick Reference](sql-quick-reference.md) - Complete Levels 1-4
3. Automate: [Automation Recipes](automation-recipes.md) - Ready-to-use scripts
4. Reference: [JSON-SQL Guide](json-sql-guide.md) - Data transformation patterns

**Result**: You have automated daily/weekly reports ✅

### I'm having problems

**Time**: 5-15 minutes | **Goal**: Resolve your specific issue

1. Go to: [Getting Started Troubleshooting Guide](getting-started-troubleshooting.md)
2. Find your error or symptom
3. Follow the step-by-step solution

**Result**: Your problem is solved ✅

### I want to manage multiple notebooks

**Time**: 20 minutes | **Goal**: Organize notes across projects

1. Read: [Notebook Discovery](notebook-discovery.md) - Multi-notebook patterns
2. Create notebooks: See "Getting Started for Power Users" - Part 1
3. Reference: [SQL Quick Reference](sql-quick-reference.md) - Switch between notebooks

**Result**: You have organized notebooks with clear discovery ✅
...
- **[Import Workflow Guide](import-workflow-guide.md)** (2,200 words, 20 min read)
  ...
  - Includes: Obsidian, Bear, generic markdown migrations
...
- **[SQL Quick Reference](sql-quick-reference.md)** (2,400 words, 4 learning levels)
  ...
  - Level 2: Content search (6 examples)
  - Level 3: Metadata analysis (6 examples)
  - Level 4: Complex queries (6 examples)
  - Includes: 25+ working examples, common mistakes, exercises
  - Follow after: Getting started guide
...
- **[Automation Recipes](automation-recipes.md)** (2,850+ words, practical guide)
  ...
  - Includes: Daily stats, weekly summaries, backups, exports
  - Patterns: Cron integration, jq pipelines, tool integration
...
- **[Getting Started Troubleshooting Guide](getting-started-troubleshooting.md)** (3,700+ words, problem-solver)
  ...
  - Features: Error messages, step-by-step solutions, FAQ
  - Coverage: Import, SQL, CLI, performance, integration
  - Use when: You encounter an error or problem
...
1. **[Getting Started for Power Users](getting-started-power-users.md)** (15 min)
   - Sections: Introduction, Part 1 (Import), Part 2 (SQL Basics)

2. **[SQL Quick Reference](sql-quick-reference.md)** (15 min)
   - Sections: SQL Basics, Level 1 (Basic Queries)

**Outcome**: Your notes are imported and you understand SELECT
...
2. **[Import Workflow Guide](import-workflow-guide.md)** (25 min)
   - Understand organization and migration

3. **[SQL Quick Reference](sql-quick-reference.md)** (45 min)
   - Complete Levels 1-3 (Basic, Search, Metadata)

4. **[Automation Recipes](automation-recipes.md)** (20 min)
   - Explore scripts and patterns
   - Try one automation recipe

5. **[JSON-SQL Guide](json-sql-guide.md)** (15 min)
   - Understand JSON output and jq basics

**Outcome**: You can import, query, and automate your workflows
...
1. **All beginner and power user content** (2 hours)
   - Complete the Power User path

2. **[SQL Guide](sql-guide.md)** (1 hour)
   - Advanced SQL patterns
   - Complex queries and optimizations

3. **[SQL Functions Reference](sql-functions-reference.md)** (30 min)
   - Complete function reference
   - Edge cases and parameters

4. **[JSON-SQL Guide](json-sql-guide.md)** (30 min)
   - Complete jq and transformation patterns
   - Tool integration examples

5. **[Automation Recipes](automation-recipes.md)** (30 min)
   - Master all scripts and patterns
   - Create custom automations

6. **[Notebook Discovery](notebook-discovery.md)** (20 min)
   - Advanced multi-notebook patterns
...
│   └── SQL Functions Reference (API reference)
│
├── 🔧 Integration & Automation
│   ├── Automation Recipes (5+ shell scripts, ready-to-use)
│   ├── JSON-SQL Guide (jq, data transformation)
│   └── Notebook Discovery (multi-notebook patterns)
│
└── 📖 This Index
